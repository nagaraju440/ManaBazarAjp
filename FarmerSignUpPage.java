 ...
 *
 */
public class FarmerSignUpPage extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FarmerSignUpPage frame = new FarmerSignUpPage();
...
ImageIcon icon = new ImageIcon("farmerimg.png");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                msg += " \n";
                if (len != 10) {
                    JOptionPane.showMessageDialog(btnNewButton, "Enter a valid mobile numberrrrr");
                }else{

                try {
                    Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/test1", "root", "");

                    String query = "INSERT INTO farmersdata values('" + firstName + "','" + address1 + "','" + userName + "','" +
